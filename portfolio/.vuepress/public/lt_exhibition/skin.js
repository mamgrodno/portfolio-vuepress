...
function pano2vrSkin(player,base) {
		...
		me._image_1.logicBlock_size = function() {
			...
			if (me._image_1.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._image_1.ggCurrentLogicStateSize == 0) {
					...
					me._image_1.style.width='418px';
					me._image_1.style.height='169px';
					skin.updateSize(me._image_1);
				}
			}
		}
	...
	player.addListener('configloaded', function(args) { me._rectangle_3.logicBlock_visible();me._controller2.logicBlock_visible();me._controller.logicBlock_visible();me._controllermobile.logicBlock_visible();me._image_1.logicBlock_size(); });
	me.skinTimerEvent();
};
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._minipano.ggScrollByX = function(diffX) {
			...
			let percentScrolled = me._minipano.ggScrollPosX / (me._minipano__horScrollBg.offsetWidth - me._minipano__horScrollFg.offsetWidth);
			me._minipano__content.style.left = -(Math.round((me._minipano.ggContentWidth * (1.0 - me._minipano.ggHPercentVisible)) * percentScrolled)) + me._minipano.ggContentLeftOffset + 'px';
		...
		me._minipano.ggScrollByY = function(diffY) {
			...
			let percentScrolled = me._minipano.ggScrollPosY / (me._minipano__vertScrollBg.offsetHeight - me._minipano__vertScrollFg.offsetHeight);
			me._minipano__content.style.top = -(Math.round((me._minipano.ggContentHeight * (1.0 - me._minipano.ggVPercentVisible)) * percentScrolled)) + me._minipano.ggContentTopOffset + 'px';
		...
		me._minipano.ggScrollIntoView = function(posX, posY, width, height) {
			if (me._minipano.ggHorScrollVisible) {
				...
				} else if (posX + width > me._minipano.clientWidth - (me._minipano.ggVertScrollVisible ? 15 : 0)) {
					var diffX = Math.ceil(((posX + width) - (me._minipano.clientWidth - (me._minipano.ggVertScrollVisible ? 15 : 0))) * me._minipano.ggHPercentVisible);
					me._minipano.ggScrollByXSmooth(diffX);
				}
			}
			if (me._minipano.ggVertScrollVisible) {
				...
				} else if (posY + height > me._minipano.clientHeight - (me._minipano.ggHorScrollVisible ? 15 : 0)) {
					var diffY = Math.ceil(((posY + height) - (me._minipano.clientHeight - (me._minipano.ggHorScrollVisible ? 15 : 0))) * me._minipano.ggVPercentVisible);
					me._minipano.ggScrollByYSmooth(diffY);
				}
			}
		}
		...
		el.addEventListener('wheel', function(e) {
			...
			me._minipano.ggScrollByXSmooth(30 * me._minipano.ggHPercentVisible * wheelDelta);
		});
		...
		me._minipano.ggUpdatePosition=function (useTransition) {
			{
				...
				if(me._minipano.ggHorScrollVisible) {
					me._minipano.ggAvailableHeight = me._minipano.clientHeight - 15;
					if (me._minipano.ggVertScrollVisible) {
						me._minipano.ggAvailableWidth = me._minipano.clientWidth - 15;
						...
						me._minipano.ggAvailableWidth = me._minipano.clientWidth;
					...
					if (me._minipano.ggHPercentVisible < 1.0) {
						let percentScrolled = me._minipano.ggScrollPosX / (me._minipano__horScrollBg.offsetWidth - me._minipano__horScrollFg.offsetWidth);
						me._minipano__content.style.left = -(Math.round((me._minipano.ggContentWidth * (1.0 - me._minipano.ggHPercentVisible)) * percentScrolled)) + this.ggContentLeftOffset + 'px';
					}
				} else {
					me._minipano.ggAvailableHeight = me._minipano.clientHeight;
					me._minipano.ggScrollPosX = 0;
					me._minipano.ggScrollPosXPercent = 0.0;
				}
		...
		me._minipanover.ggScrollByX = function(diffX) {
			...
			let percentScrolled = me._minipanover.ggScrollPosX / (me._minipanover__horScrollBg.offsetWidth - me._minipanover__horScrollFg.offsetWidth);
			me._minipanover__content.style.left = -(Math.round((me._minipanover.ggContentWidth * (1.0 - me._minipanover.ggHPercentVisible)) * percentScrolled)) + me._minipanover.ggContentLeftOffset + 'px';
		...
		me._minipanover.ggScrollByY = function(diffY) {
			...
			let percentScrolled = me._minipanover.ggScrollPosY / (me._minipanover__vertScrollBg.offsetHeight - me._minipanover__vertScrollFg.offsetHeight);
			me._minipanover__content.style.top = -(Math.round((me._minipanover.ggContentHeight * (1.0 - me._minipanover.ggVPercentVisible)) * percentScrolled)) + me._minipanover.ggContentTopOffset + 'px';
		...
		me._minipanover.ggScrollIntoView = function(posX, posY, width, height) {
			if (me._minipanover.ggHorScrollVisible) {
				...
				} else if (posX + width > me._minipanover.clientWidth - (me._minipanover.ggVertScrollVisible ? 15 : 0)) {
					var diffX = Math.ceil(((posX + width) - (me._minipanover.clientWidth - (me._minipanover.ggVertScrollVisible ? 15 : 0))) * me._minipanover.ggHPercentVisible);
					me._minipanover.ggScrollByXSmooth(diffX);
				}
			}
			if (me._minipanover.ggVertScrollVisible) {
				...
				} else if (posY + height > me._minipanover.clientHeight - (me._minipanover.ggHorScrollVisible ? 15 : 0)) {
					var diffY = Math.ceil(((posY + height) - (me._minipanover.clientHeight - (me._minipanover.ggHorScrollVisible ? 15 : 0))) * me._minipanover.ggVPercentVisible);
					me._minipanover.ggScrollByYSmooth(diffY);
				}
			}
		}
		...
		el.addEventListener('wheel', function(e) {
			e.preventDefault();
			var wheelDelta = Math.sign(e.deltaX);
			me._minipanover.ggScrollByXSmooth(30 * me._minipanover.ggHPercentVisible * wheelDelta);
		});
		...
		me._minipanover.ggUpdatePosition=function (useTransition) {
			{
				...
				if(me._minipanover.ggHorScrollVisible) {
					me._minipanover.ggAvailableHeight = me._minipanover.clientHeight - 15;
					if (me._minipanover.ggVertScrollVisible) {
						me._minipanover.ggAvailableWidth = me._minipanover.clientWidth - 15;
						...
						me._minipanover.ggAvailableWidth = me._minipanover.clientWidth;
					...
					if (me._minipanover.ggHPercentVisible < 1.0) {
						let percentScrolled = me._minipanover.ggScrollPosX / (me._minipanover__horScrollBg.offsetWidth - me._minipanover__horScrollFg.offsetWidth);
						me._minipanover__content.style.left = -(Math.round((me._minipanover.ggContentWidth * (1.0 - me._minipanover.ggHPercentVisible)) * percentScrolled)) + this.ggContentLeftOffset + 'px';
					}
				} else {
					me._minipanover.ggAvailableHeight = me._minipanover.clientHeight;
					me._minipanover.ggScrollPosX = 0;
					me._minipanover.ggScrollPosXPercent = 0.0;
				}
		...
		me._minipanohor.ggScrollByX = function(diffX) {
			...
			let percentScrolled = me._minipanohor.ggScrollPosX / (me._minipanohor__horScrollBg.offsetWidth - me._minipanohor__horScrollFg.offsetWidth);
			me._minipanohor__content.style.left = -(Math.round((me._minipanohor.ggContentWidth * (1.0 - me._minipanohor.ggHPercentVisible)) * percentScrolled)) + me._minipanohor.ggContentLeftOffset + 'px';
		...
		me._minipanohor.ggScrollByY = function(diffY) {
			...
			let percentScrolled = me._minipanohor.ggScrollPosY / (me._minipanohor__vertScrollBg.offsetHeight - me._minipanohor__vertScrollFg.offsetHeight);
			me._minipanohor__content.style.top = -(Math.round((me._minipanohor.ggContentHeight * (1.0 - me._minipanohor.ggVPercentVisible)) * percentScrolled)) + me._minipanohor.ggContentTopOffset + 'px';
		...
		me._minipanohor.ggScrollIntoView = function(posX, posY, width, height) {
			if (me._minipanohor.ggHorScrollVisible) {
				...
				} else if (posX + width > me._minipanohor.clientWidth - (me._minipanohor.ggVertScrollVisible ? 15 : 0)) {
					var diffX = Math.ceil(((posX + width) - (me._minipanohor.clientWidth - (me._minipanohor.ggVertScrollVisible ? 15 : 0))) * me._minipanohor.ggHPercentVisible);
					me._minipanohor.ggScrollByXSmooth(diffX);
				}
			}
			if (me._minipanohor.ggVertScrollVisible) {
				...
				} else if (posY + height > me._minipanohor.clientHeight - (me._minipanohor.ggHorScrollVisible ? 15 : 0)) {
					var diffY = Math.ceil(((posY + height) - (me._minipanohor.clientHeight - (me._minipanohor.ggHorScrollVisible ? 15 : 0))) * me._minipanohor.ggVPercentVisible);
					me._minipanohor.ggScrollByYSmooth(diffY);
				}
			}
		}
		...
		el.addEventListener('wheel', function(e) {
			...
			me._minipanohor.ggScrollByYSmooth(30 * me._minipanohor.ggVPercentVisible * wheelDelta);
		});
		...
		me._minipanohor.ggUpdatePosition=function (useTransition) {
			{
				...
				if ((me._minipanohor.ggHorScrollVisible && contentHeight > this.clientHeight - 15) || (!me._minipanohor.ggHorScrollVisible && contentHeight > this.clientHeight)) {
				...
				if(me._minipanohor.ggVertScrollVisible) {
					me._minipanohor.ggAvailableWidth = me._minipanohor.clientWidth - 15;
					if (me._minipanohor.ggHorScrollVisible) {
						me._minipanohor.ggAvailableHeight = me._minipanohor.clientHeight - 15;
						...
						me._minipanohor.ggAvailableHeight = me._minipanohor.clientHeight;
					...
					me._minipanohor.ggAvailableWidth = me._minipanohor.clientWidth;
					me._minipanohor.ggScrollPosY = 0;
					me._minipanohor.ggScrollPosYPercent = 0.0;
					me._minipanohor__cornerBg.style.visibility = 'hidden';
				}
...
this.__div.style.top = vs.height / 2 + "px";
	...
	function SkinCloner_thumbnail_cloner1_Class(nodeId, parentScope,ggParent,parameter) {
		...
		hs='data:image/svg+xml;base64,'+
	...
	player.addListener('mouseover', function(args) { me.callChildLogicBlocksHotspot_ht_node2_mouseover(); });

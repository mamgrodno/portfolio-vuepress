...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._minipano.ggScrollByX = function(diffX) {
			if(!me._minipano.ggHorScrollVisible || diffX == 0 || me._minipano.ggHPercentVisible >= 1.0) return;
		...
		me._minipano.ggScrollByY = function(diffY) {
			if(!me._minipano.ggVertScrollVisible || diffY == 0 || me._minipano.ggVPercentVisible >= 1.0) return;
		...
		els.ontouchstart = function(e) {
			e = e || window.event;
			var t = e.touches;
			me._minipano.ggDragLastX = t ? t[0].clientX : e.clientX;
			me._minipano.ggDragLastY = t ? t[0].clientY : e.clientY;
			me._minipano__content.ontouchend = function() {
				let inertiaInterval = setInterval(function() {
					me._minipano.ggDragInertiaX *= 0.65;
					me._minipano.ggDragInertiaY *= 0.65;
					me._minipano.ggScrollByX(me._minipano.ggDragInertiaX);
					me._minipano.ggScrollByY(me._minipano.ggDragInertiaY);
					if (Math.abs(me._minipano.ggDragInertiaX) < 1.0 && Math.abs(me._minipano.ggDragInertiaY) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 50);
				me._minipano__content.ontouchend = null;
				me._minipano__content.ontouchmove = null;
				me._minipano__content.onpointerup = null;
				me._minipano__content.onpointermove = null;
			}
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
			me._minipano__content.onpointerup = me._minipano__content.ontouchend;
		}
			me._minipano__content.ontouchmove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var t = e.touches;
				var diffX = ((t ? t[0].clientX : e.clientX) - me._minipano.ggDragLastX) * me._minipano.ggHPercentVisible;
				var diffY = ((t ? t[0].clientY : e.clientY) - me._minipano.ggDragLastY) * me._minipano.ggVPercentVisible;
				me._minipano.ggDragInertiaX = -diffX;
				me._minipano.ggDragInertiaY = -diffY;
				me._minipano.ggDragLastX = t ? t[0].clientX : e.clientX;
				me._minipano.ggDragLastY = t ? t[0].clientY : e.clientY;
			...
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
				me._minipano__content.onpointermove = me._minipano__content.ontouchmove;
			}
		}
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
		...
		elHorScrollFg.onmousedown = function(e) {
			...
			document.onmouseup = function() {
				let inertiaInterval = setInterval(function() {
					me._minipano.ggDragInertiaX *= 0.65;
					me._minipano.ggScrollByX(me._minipano.ggDragInertiaX);
					if (Math.abs(me._minipano.ggDragInertiaX) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 50);
		...
		elHorScrollFg.ontouchstart = function(e) {
			...
			document.ontouchmove = function(e) {
				...
				e.preventDefault();
				var t = e.touches;
				var diffX = (t ? t[0].clientX : e.clientX) - me._minipano.ggDragLastX;
				me._minipano.ggDragInertiaX = diffX;
				me._minipano.ggDragLastX = t ? t[0].clientX : e.clientX;
				me._minipano.ggScrollByX(diffX);
			}
		...
		me._minipano.ggUpdatePosition=function (useTransition) {
			{
				...
				if(me._minipano.ggHorScrollVisible) {
					...
					me._minipano.ggHPercentVisible = contentWidth != 0 ? me._minipano.ggAvailableWidthWithScale / contentWidth : 0.0;
					...
					me._minipano.ggScrollPosX = Math.min(me._minipano.ggScrollPosX, me._minipano__horScrollBg.offsetWidth - me._minipano__horScrollFg.offsetWidth);
					me._minipano__horScrollFg.style.left = me._minipano.ggScrollPosX + 'px';
					if (me._minipano.ggHPercentVisible < 1.0) {
		...
		me._thumbnail_cloner1.callChildLogicBlocks_mouseover = function(){
			if(me._thumbnail_cloner1.ggInstances) {
				var i;
				for(i = 0; i < me._thumbnail_cloner1.ggInstances.length; i++) {
					if (me._thumbnail_cloner1.ggInstances[i]._node_text3 && me._thumbnail_cloner1.ggInstances[i]._node_text3.logicBlock_visible) {
						me._thumbnail_cloner1.ggInstances[i]._node_text3.logicBlock_visible();
					}
					if (me._thumbnail_cloner1.ggInstances[i]._node_text22 && me._thumbnail_cloner1.ggInstances[i]._node_text22.logicBlock_visible) {
						me._thumbnail_cloner1.ggInstances[i]._node_text22.logicBlock_visible();
					}
				}
			}
		}
		...
		me._minipanover.ggScrollByX = function(diffX) {
			if(!me._minipanover.ggHorScrollVisible || diffX == 0 || me._minipanover.ggHPercentVisible >= 1.0) return;
		...
		me._minipanover.ggScrollByY = function(diffY) {
			if(!me._minipanover.ggVertScrollVisible || diffY == 0 || me._minipanover.ggVPercentVisible >= 1.0) return;
		...
		els.ontouchstart = function(e) {
			e = e || window.event;
			var t = e.touches;
			me._minipanover.ggDragLastX = t ? t[0].clientX : e.clientX;
			me._minipanover.ggDragLastY = t ? t[0].clientY : e.clientY;
			me._minipanover__content.ontouchend = function() {
				let inertiaInterval = setInterval(function() {
					me._minipanover.ggDragInertiaX *= 0.65;
					me._minipanover.ggDragInertiaY *= 0.65;
					me._minipanover.ggScrollByX(me._minipanover.ggDragInertiaX);
					me._minipanover.ggScrollByY(me._minipanover.ggDragInertiaY);
					if (Math.abs(me._minipanover.ggDragInertiaX) < 1.0 && Math.abs(me._minipanover.ggDragInertiaY) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 50);
				me._minipanover__content.ontouchend = null;
				me._minipanover__content.ontouchmove = null;
				me._minipanover__content.onpointerup = null;
				me._minipanover__content.onpointermove = null;
			}
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
			me._minipanover__content.onpointerup = me._minipanover__content.ontouchend;
		}
			me._minipanover__content.ontouchmove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var t = e.touches;
				var diffX = ((t ? t[0].clientX : e.clientX) - me._minipanover.ggDragLastX) * me._minipanover.ggHPercentVisible;
				var diffY = ((t ? t[0].clientY : e.clientY) - me._minipanover.ggDragLastY) * me._minipanover.ggVPercentVisible;
				me._minipanover.ggDragInertiaX = -diffX;
				me._minipanover.ggDragInertiaY = -diffY;
				me._minipanover.ggDragLastX = t ? t[0].clientX : e.clientX;
				me._minipanover.ggDragLastY = t ? t[0].clientY : e.clientY;
			...
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
				me._minipanover__content.onpointermove = me._minipanover__content.ontouchmove;
			}
		}
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
			els.onpointerdown = els.ontouchstart;
		...
		elHorScrollFg.onmousedown = function(e) {
			...
			document.onmouseup = function() {
				let inertiaInterval = setInterval(function() {
					me._minipanover.ggDragInertiaX *= 0.65;
					me._minipanover.ggScrollByX(me._minipanover.ggDragInertiaX);
					if (Math.abs(me._minipanover.ggDragInertiaX) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 50);
				document.onmouseup = null;
		...
		elHorScrollFg.ontouchstart = function(e) {
			...
			document.ontouchmove = function(e) {
				...
				e.preventDefault();
				var t = e.touches;
				var diffX = (t ? t[0].clientX : e.clientX) - me._minipanover.ggDragLastX;
				me._minipanover.ggDragInertiaX = diffX;
				me._minipanover.ggDragLastX = t ? t[0].clientX : e.clientX;
				me._minipanover.ggScrollByX(diffX);
			}
		...
		me._minipanover.ggUpdatePosition=function (useTransition) {
			{
				...
				if(me._minipanover.ggHorScrollVisible) {
					...
					me._minipanover.ggHPercentVisible = contentWidth != 0 ? me._minipanover.ggAvailableWidthWithScale / contentWidth : 0.0;
					...
					me._minipanover.ggScrollPosX = Math.min(me._minipanover.ggScrollPosX, me._minipanover__horScrollBg.offsetWidth - me._minipanover__horScrollFg.offsetWidth);
					me._minipanover__horScrollFg.style.left = me._minipanover.ggScrollPosX + 'px';
					if (me._minipanover.ggHPercentVisible < 1.0) {
		...
		me._thumbnail_cloner0.callChildLogicBlocks_mouseover = function(){
			if(me._thumbnail_cloner0.ggInstances) {
				var i;
				for(i = 0; i < me._thumbnail_cloner0.ggInstances.length; i++) {
					if (me._thumbnail_cloner0.ggInstances[i]._node_text1 && me._thumbnail_cloner0.ggInstances[i]._node_text1.logicBlock_visible) {
						me._thumbnail_cloner0.ggInstances[i]._node_text1.logicBlock_visible();
					}
					if (me._thumbnail_cloner0.ggInstances[i]._node_text21 && me._thumbnail_cloner0.ggInstances[i]._node_text21.logicBlock_visible) {
						me._thumbnail_cloner0.ggInstances[i]._node_text21.logicBlock_visible();
					}
				}
			}
		}
		...
		me._minipanohor.ggScrollByX = function(diffX) {
			if(!me._minipanohor.ggHorScrollVisible || diffX == 0 || me._minipanohor.ggHPercentVisible >= 1.0) return;
		...
		me._minipanohor.ggScrollByY = function(diffY) {
			if(!me._minipanohor.ggVertScrollVisible || diffY == 0 || me._minipanohor.ggVPercentVisible >= 1.0) return;
		...
		els.ontouchstart = function(e) {
			e = e || window.event;
			var t = e.touches;
			me._minipanohor.ggDragLastX = t ? t[0].clientX : e.clientX;
			me._minipanohor.ggDragLastY = t ? t[0].clientY : e.clientY;
			me._minipanohor__content.ontouchend = function() {
				let inertiaInterval = setInterval(function() {
					me._minipanohor.ggDragInertiaX *= 0.65;
					me._minipanohor.ggDragInertiaY *= 0.65;
					me._minipanohor.ggScrollByX(me._minipanohor.ggDragInertiaX);
					me._minipanohor.ggScrollByY(me._minipanohor.ggDragInertiaY);
					if (Math.abs(me._minipanohor.ggDragInertiaX) < 1.0 && Math.abs(me._minipanohor.ggDragInertiaY) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 50);
				me._minipanohor__content.ontouchend = null;
				me._minipanohor__content.ontouchmove = null;
				me._minipanohor__content.onpointerup = null;
				me._minipanohor__content.onpointermove = null;
			}
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
			me._minipanohor__content.onpointerup = me._minipanohor__content.ontouchend;
		}
			me._minipanohor__content.ontouchmove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var t = e.touches;
				var diffX = ((t ? t[0].clientX : e.clientX) - me._minipanohor.ggDragLastX) * me._minipanohor.ggHPercentVisible;
				var diffY = ((t ? t[0].clientY : e.clientY) - me._minipanohor.ggDragLastY) * me._minipanohor.ggVPercentVisible;
				me._minipanohor.ggDragInertiaX = -diffX;
				me._minipanohor.ggDragInertiaY = -diffY;
				me._minipanohor.ggDragLastX = t ? t[0].clientX : e.clientX;
				me._minipanohor.ggDragLastY = t ? t[0].clientY : e.clientY;
			...
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
				me._minipanohor__content.onpointermove = me._minipanohor__content.ontouchmove;
			}
		}
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
			els.onpointerdown = els.ontouchstart;
		...
		elVertScrollFg.onmousedown = function(e) {
			...
			document.onmouseup = function() {
				let inertiaInterval = setInterval(function() {
					me._minipanohor.ggDragInertiaY *= 0.65;
					me._minipanohor.ggScrollByY(me._minipanohor.ggDragInertiaY);
					if (Math.abs(me._minipanohor.ggDragInertiaY) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 50);
				document.onmouseup = null;
		...
		elVertScrollFg.ontouchstart = function(e) {
			...
			document.ontouchmove = function(e) {
				...
				e.preventDefault();
				var t = e.touches;
				var diffY = (t ? t[0].clientY : e.clientY) - me._minipanohor.ggDragLastY;
				me._minipanohor.ggDragInertiaY = diffY;
				me._minipanohor.ggDragLastY = t ? t[0].clientY : e.clientY;
				me._minipanohor.ggScrollByY(diffY);
			}
		...
		me._minipanohor.ggUpdatePosition=function (useTransition) {
			{
				...
				if(me._minipanohor.ggVertScrollVisible) {
					...
					me._minipanohor.ggVPercentVisible = contentHeight != 0 ? me._minipanohor.ggAvailableHeightWithScale / contentHeight : 0.0;
					...
					me._minipanohor.ggScrollPosY = Math.min(me._minipanohor.ggScrollPosY, me._minipanohor__vertScrollBg.offsetHeight - me._minipanohor__vertScrollFg.offsetHeight);
					me._minipanohor__vertScrollFg.style.top = me._minipanohor.ggScrollPosY + 'px';
					if (me._minipanohor.ggVPercentVisible < 1.0) {
		...
		me._thumbnail_cloner.callChildLogicBlocks_mouseover = function(){
			if(me._thumbnail_cloner.ggInstances) {
				var i;
				for(i = 0; i < me._thumbnail_cloner.ggInstances.length; i++) {
					if (me._thumbnail_cloner.ggInstances[i]._node_text0 && me._thumbnail_cloner.ggInstances[i]._node_text0.logicBlock_visible) {
						me._thumbnail_cloner.ggInstances[i]._node_text0.logicBlock_visible();
					}
					if (me._thumbnail_cloner.ggInstances[i]._node_text20 && me._thumbnail_cloner.ggInstances[i]._node_text20.logicBlock_visible) {
						me._thumbnail_cloner.ggInstances[i]._node_text20.logicBlock_visible();
					}
				}
			}
		}
		...
		el=me._tooltipb=document.createElement('div');
		els=me._tooltipb__text=document.createElement('div');
		...
		els.innerHTML="";
		el.appendChild(els);
		me._tooltipb.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._tooltipb.onmouseover=function (e) {
			me._tooltipb.ggText="<b>"+player.hotspot.title+"<\/b>";
			me._tooltipb.ggTextDiv.innerHTML=me._tooltipb.ggText;
			if (me._tooltipb.ggUpdateText) {
				me._tooltipb.ggUpdateText=function() {
					var hs="<b>"+player.hotspot.title+"<\/b>";
					if (hs!=this.ggText) {
						this.ggText=hs;
			...
			if (me._tooltipb.ggUpdatePosition) {
				me._tooltipb.ggUpdatePosition();
			}
			me._tooltipb.ggTextDiv.scrollTop = 0;
		}
		me._tooltipb.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._tooltipb);
		el=me._tooltipw=document.createElement('div');
		els=me._tooltipw__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="tooltipw";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		els.innerHTML="";
		el.appendChild(els);
		me._tooltipw.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._tooltipw.onmouseover=function (e) {
			me._tooltipw.ggText="<b>"+player.hotspot.title+"<\/b>";
			me._tooltipw.ggTextDiv.innerHTML=me._tooltipw.ggText;
			if (me._tooltipw.ggUpdateText) {
				me._tooltipw.ggUpdateText=function() {
					var hs="<b>"+player.hotspot.title+"<\/b>";
					if (hs!=this.ggText) {
						this.ggText=hs;
						this.ggTextDiv.innerHTML=hs;
			...
			if (me._tooltipw.ggUpdatePosition) {
				me._tooltipw.ggUpdatePosition();
			}
			me._tooltipw.ggTextDiv.scrollTop = 0;
		}
		me._tooltipw.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._tooltipw);
	...
	me.hotspotProxyOver=function(id, url) {
		me._tooltipb.onmouseover();
		me._tooltipw.onmouseover();
	}
	...
	me.callChildLogicBlocksHotspot_ht_node_changenode = function(){
		if(hotspotTemplates['ht_node']) {
			...
			for(i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				...
				if (hotspotTemplates['ht_node'][i]._rectangle_1 && hotspotTemplates['ht_node'][i]._rectangle_1.logicBlock_bordercolor) {
					hotspotTemplates['ht_node'][i]._rectangle_1.logicBlock_bordercolor();
				}
				if (hotspotTemplates['ht_node'][i]._rectangle_2 && hotspotTemplates['ht_node'][i]._rectangle_2.logicBlock_scaling) {
					hotspotTemplates['ht_node'][i]._rectangle_2.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_node'][i]._rectangle_2 && hotspotTemplates['ht_node'][i]._rectangle_2.logicBlock_alpha) {
					hotspotTemplates['ht_node'][i]._rectangle_2.logicBlock_alpha();
				}
				if (hotspotTemplates['ht_node'][i]._rectangle_2 && hotspotTemplates['ht_node'][i]._rectangle_2.logicBlock_bordercolor) {
					hotspotTemplates['ht_node'][i]._rectangle_2.logicBlock_bordercolor();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_node_mouseover = function(){
		if(hotspotTemplates['ht_node']) {
			...
			for(i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				...
				if (hotspotTemplates['ht_node'][i]._node_text && hotspotTemplates['ht_node'][i]._node_text.logicBlock_visible) {
					hotspotTemplates['ht_node'][i]._node_text.logicBlock_visible();
				}
				if (hotspotTemplates['ht_node'][i]._node_text2 && hotspotTemplates['ht_node'][i]._node_text2.logicBlock_visible) {
					hotspotTemplates['ht_node'][i]._node_text2.logicBlock_visible();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_node_varchanged_ht_anivar1 = function(){
		if(hotspotTemplates['ht_node']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				if (hotspotTemplates['ht_node'][i]._rectangle_1 && hotspotTemplates['ht_node'][i]._rectangle_1.logicBlock_scaling) {
	...
	me.skinTimerEvent=function() {
		...
		var hs='';
		if (me._tooltipb.ggParameter) {
			hs+=parameterToTransform(me._tooltipb.ggParameter) + ' ';
		}
		hs+='translate(' + (1 * player.mouse.x + 0) + 'px,0px) ';
		hs+='translate(0px,' + (1 * player.mouse.y + 0) + 'px) ';
		me._tooltipb.style[domTransform]=hs;
		var hs='';
		if (me._tooltipw.ggParameter) {
			hs+=parameterToTransform(me._tooltipw.ggParameter) + ' ';
		}
		hs+='translate(' + (1 * player.mouse.x + 0) + 'px,0px) ';
		hs+='translate(0px,' + (1 * player.mouse.y + 0) + 'px) ';
		me._tooltipw.style[domTransform]=hs;
	};
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		me._ht_node.onclick=function (e) {
			...
			skin._tooltipw.style[domTransition]='none';
			skin._tooltipw.style.visibility='hidden';
			skin._tooltipw.ggVisible=false;
			skin._tooltipb.style[domTransition]='none';
			skin._tooltipb.style.visibility='hidden';
			skin._tooltipb.ggVisible=false;
		...
		me._ht_node.onmouseover=function (e) {
			...
			skin._tooltipw.style[domTransition]='none';
			skin._tooltipw.style.visibility=(Number(skin._tooltipw.style.opacity)>0||!skin._tooltipw.style.opacity)?'inherit':'hidden';
			skin._tooltipw.ggVisible=true;
			skin._tooltipb.style[domTransition]='none';
			skin._tooltipb.style.visibility=(Number(skin._tooltipb.style.opacity)>0||!skin._tooltipb.style.opacity)?'inherit':'hidden';
			skin._tooltipb.ggVisible=true;
		...
		me._rectangle_1.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_1.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_1.ggCurrentLogicStateBorderColor == 0) {
					...
					me._rectangle_1.style.borderColor="rgba(194,252,255,1)";
				}
			}
		}
		...
		me._rectangle_2.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_2.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_2.ggCurrentLogicStateBorderColor == 0) {
					...
					me._rectangle_2.style.borderColor="rgba(194,252,255,1)";
				}
			}
		}
		...
		me._ht_node.appendChild(me._upanicircle);
		...
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._node_text.ggUpdateText=function() {
			var hs="<font face=\"Century Gothic\" size=2>   "+me.ggUserdata.description+" <\/font>";
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._ht_node.appendChild(me._node_text);
		...
		me._ht_node.appendChild(me._node_text2);
	...
	me.addSkinHotspot=function(hotspot) {
		var hsinst = null;
		{
			...
			me.callChildLogicBlocksHotspot_ht_node_varchanged_ht_anivar1();;
		}
		return hsinst;
	}
	...
	function SkinCloner_thumbnail_cloner1_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me._thumbnail_nodeimage1.onmouseover=function (e) {
			...
			me._node_text3.logicBlock_visible();
			me._node_text22.logicBlock_visible();
		}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'';
		...
		el=me._node_text3=document.createElement('div');
		els=me._node_text3__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="node Text";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		el.appendChild(els);
		me._node_text3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._node_text3.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.elementMouseOver['thumbnail_nodeimage1'] == true))
			)
			...
			if (me._node_text3.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._node_text3.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._node_text3.style[domTransition]='';
				if (me._node_text3.ggCurrentLogicStateVisible == 0) {
					me._node_text3.style.visibility=(Number(me._node_text3.style.opacity)>0||!me._node_text3.style.opacity)?'inherit':'hidden';
					me._node_text3.ggVisible=true;
				}
				else {
					me._node_text3.style.visibility="hidden";
					me._node_text3.ggVisible=false;
				}
			}
		}
		me._node_text3.ggUpdatePosition=function (useTransition) {
		}
		me._thumbnail_nodeimage1.appendChild(me._node_text3);
		el=me._node_text22=document.createElement('div');
		els=me._node_text22__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="node Text2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		els.innerHTML="<b>"+me.ggUserdata.description+"<\/b>";
		el.appendChild(els);
		me._node_text22.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._node_text22.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.elementMouseOver['thumbnail_nodeimage1'] == true))
			)
			...
			if (me._node_text22.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._node_text22.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._node_text22.style[domTransition]='';
				if (me._node_text22.ggCurrentLogicStateVisible == 0) {
					me._node_text22.style.visibility=(Number(me._node_text22.style.opacity)>0||!me._node_text22.style.opacity)?'inherit':'hidden';
					me._node_text22.ggVisible=true;
				}
				else {
					me._node_text22.style.visibility="hidden";
					me._node_text22.ggVisible=false;
				}
			}
		}
		me._node_text22.ggUpdatePosition=function (useTransition) {
		}
		me._thumbnail_nodeimage1.appendChild(me._node_text22);
	...
	function SkinCloner_thumbnail_cloner0_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me._thumbnail_nodeimage0.appendChild(me._node_text1);
		...
		me._thumbnail_nodeimage0.appendChild(me._node_text21);
	...
	function SkinCloner_thumbnail_cloner_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me._thumbnail_nodeimage.appendChild(me._node_text0);
		...
		me._thumbnail_nodeimage.appendChild(me._node_text20);
	...
	player.addListener('varchanged_ht_anivar1', function(args) { me.callChildLogicBlocksHotspot_ht_node_varchanged_ht_anivar1(); });
